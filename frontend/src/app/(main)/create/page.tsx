...
const MOOD_OPTIONS: GuideOption[] = [
  ...
  { label: "Dreamy / Soft",     description: "Ethereal and gentle. Soft diffused light and pastel tones for a dreamy, aspirational feel." },
...
const STYLE_OPTIONS: GuideOption[] = [
  ...
  { label: "Close-up / Macro", description: "Extreme close-ups on product texture, material, and detail. Intimate and tactile." },
 ...
 *  LTX Video 2.3 is camera-instruction-sensitive: this chip maps directly to
 *  a concrete camera cue in the Gemini-generated prompt (e.g. "Slow Zoom In"
 *  → "camera slowly zooms in"). Selecting this category significantly improves
 *  LTX output quality for product reels. */
const CAMERA_OPTIONS: GuideOption[] = [
  { label: "Slow Zoom In",      description: "Camera gradually zooms toward the subject. Builds intimacy and draws focus to the product." },
  { label: "Orbit / Revolve",   description: "Camera circles smoothly around the subject. Showcases the product from every angle." },
  { label: "Dolly Forward",     description: "Camera moves forward into the scene. Creates depth and a sense of entering the world." },
  { label: "Handheld",          description: "Subtle camera shake. Feels natural and authentic — great for UGC-style content." },
  { label: "Static Close-up",   description: "Camera holds perfectly still on a tight close-up. Product texture and detail take center stage." },
  { label: "Tilt Reveal",       description: "Camera tilts down to gradually reveal the product. Creates suspense and a satisfying reveal moment." },
];
...
const CreateReel = () => {
  ...
  // Camera Motion: maps to a concrete LTX Video camera instruction in the generated prompt
          ...
          <div className="relative rounded-3xl border border-border bg-card shadow-elevated overflow-hidden group focus-within:border-primary/30 transition-colors">
            ...
            {guidedMode && (
              <div className="mx-5 mt-2 mb-1 rounded-xl border border-primary/20 bg-primary/5 p-3 space-y-3">
                ...
                {/* Row 6: Camera Motion — maps directly to an LTX Video camera instruction.
                     Selecting this row significantly improves LTX output quality since
                     camera movement is a critical parameter for the model. */}
                <div className="space-y-1.5">
                  <p className="text-sm font-semibold text-foreground">
                    Camera Motion
                    <span className="ml-1.5 text-[9px] font-normal text-primary/70 uppercase tracking-wider">Recommended for LTX</span>
                  </p>
                  <div className="flex flex-wrap gap-1.5">
